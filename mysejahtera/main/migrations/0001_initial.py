    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regionName', models.CharField(default='', max_length=200)),
                ...
                ('country_timezone', models.CharField(default='', max_length=200)),
                ('location_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
